  ...
  (function(factory) {
    ...
    function isVersionAtLeast(dottedVersion, major, minor, patch) {
      var i,
        ...
        testParts = $.map(Array.prototype.slice.call(arguments, 1), function(
          e
        ) {
          return parseInt(e, 10);
        });
          ...
          if ($.isFunction(source.promise)) {
            ...
            source
              ...
              .fail(function(error) {
                ...
                if (
                  tree._triggerNodeEvent("loadError", ctxErr, null) !== false
                ) {
                  tree.nodeSetStatus(
                    ctx,
                    "error",
...
*/
        ...
        nodeSetFocus: function(ctx, flag) {
          ...
          if (flag) {
            ...
            if (opts.titlesTabbable) {
              ...
              // neccessary:
              if (
                $(document.activeElement).closest(".fancytree-container")
                  .length === 0
              ) {
    ...
    return $.ui.fancytree;
  }); // End of closure // Extending Fancytree
    ...
    $.ui.fancytree.registerExtension({
      ...
      nodeRenderTitle: function(ctx, title) {
        ...
        if (
          ...
          $("span.fancytree-icon", node.span).append(
 ...
 */ // End of closure
  ...
  /*! Extension 'jquery.fancytree.clones.js' */ (function(factory) {
    if (typeof define === "function" && define.amd) {
      // AMD. Register as an anonymous module.
      define(["jquery", "./jquery.fancytree"], factory);
    } else if (typeof module === "object" && module.exports) {
      ...
      treeRegisterNode: function(ctx, add, node) {
        ...
        if (add) {
          if (keyMap[node.key] != null) {
            $.error(
              "clones.treeRegisterNode: node.key already exists: " + node
            );
          }
          keyMap[key] = node;
          if (refKey) {
    ...
    $.ui.fancytree.registerExtension({
      ...
      treeInit: function(ctx) {
              ...
              case "dragstart":
                ...
                if (dataTransfer.setDragImage) {
                  ...
                  dataTransfer.setDragImage(
                    $(node.span).find(".fancytree-title")[0],
                    -10,
                    -10
                  );
        ...
        if (dndOpts.dragEnter) {
          ...
          tree.$container.on("dragenter dragover dragleave drop", function(
            event
          ) {
            var json,
              nodeData,
 ...
 */ // End of closure
  ...
  /*! Extension 'jquery.fancytree.edit.js' */ (function(factory) {
    if (typeof define === "function" && define.amd) {
      // AMD. Register as an anonymous module.
      define(["jquery", "./jquery.fancytree"], factory);
    } else if (typeof module === "object" && module.exports) {
 ...
 */ // End of closure
  ...
  /*! Extension 'jquery.fancytree.filter.js' */ (function(factory) {
    if (typeof define === "function" && define.amd) {
      // AMD. Register as an anonymous module.
      define(["jquery", "./jquery.fancytree"], factory);
    } else if (typeof module === "object" && module.exports) {
 ...
 */ // End of closure
  ...
  /*! Extension 'jquery.fancytree.glyph.js' */ (function(factory) {
    if (typeof define === "function" && define.amd) {
      // AMD. Register as an anonymous module.
      define(["jquery", "./jquery.fancytree"], factory);
    } else if (typeof module === "object" && module.exports) {
    ...
    var FT = $.ui.fancytree,
      PRESETS = {
        ...
        awesome4: {
          ...
          error: "fa-warning",
          expanderClosed: "fa-folder-o",
          expanderLazy: "fa-angle-right",
          expanderOpen: "fa-folder-open-o",
 ...
 */ // End of closure
  ...
  /*! Extension 'jquery.fancytree.gridnav.js' */ (function(factory) {
    if (typeof define === "function" && define.amd) {
      // AMD. Register as an anonymous module.
      define([
        "jquery",
 ...
 */ // End of closure
  ...
  /*! Extension 'jquery.fancytree.persist.js' */ (function(factory) {
    if (typeof define === "function" && define.amd) {
      // AMD. Register as an anonymous module.
      define(["jquery", "./jquery.fancytree"], factory);
    } else if (typeof module === "object" && module.exports) {
 ...
 */
    ...
    $.ui.fancytree._FancytreeClass.prototype.clearCookies = function(types) {
      this.warn(
        "'tree.clearCookies()' is deprecated since v2.27.0: use 'clearData()' instead."
      );
 ...
 */ // End of closure
  ...
  /*! Extension 'jquery.fancytree.table.js' */ (function(factory) {
    if (typeof define === "function" && define.amd) {
      // AMD. Register as an anonymous module.
      define(["jquery", "./jquery.fancytree"], factory);
    } else if (typeof module === "object" && module.exports) {
 ...
 */ // End of closure
  ...
  /*! Extension 'jquery.fancytree.themeroller.js' */ (function(factory) {
    if (typeof define === "function" && define.amd) {
      // AMD. Register as an anonymous module.
      define(["jquery", "./jquery.fancytree"], factory);
    } else if (typeof module === "object" && module.exports) {
 ...
 */ // End of closure
  ...
  /*! Extension 'jquery.fancytree.wide.js' */ (function(factory) {
    if (typeof define === "function" && define.amd) {
      // AMD. Register as an anonymous module.
      define(["jquery", "./jquery.fancytree"], factory);
    } else if (typeof module === "object" && module.exports) {
  ...
  var FT = $.ui.fancytree,
    PRESETS = {
      ...
      awesome4: {
        ...
        dragHelper: "fa-chevron-circle-right",
        dropMarker: "fa-chevron-circle-right",
        error: "fa-warning",
        expanderClosed: "fa-chevron-circle-right",
        expanderLazy: "fa-angle-right",
        expanderOpen: "fa-chevron-circle-down",
